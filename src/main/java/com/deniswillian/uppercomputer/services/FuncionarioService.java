...
public class FuncionarioService {
	...
	public Funcionario fromDTO(FuncionarioNewDTO objDto) {
		Funcionario func = new Funcionario(null, objDto.getNm_func(), objDto.getRg_fun(), objDto.getCpf_func(),
				objDto.getEmail_func(), objDto.getSalario(), pe.encode(objDto.getSenha()), objDto.getLogradouro(),
				objDto.getNumero(), objDto.getComplemento(), objDto.getBairro(), objDto.getCep(), null,
				TipoFuncionario.toEnum(objDto.getTipo()), null);

		/*
		 * (null, objDto.getNm_func(), objDto.getRg_fun(), objDto.getCpf_func(),
		 * objDto.getEmail_func(),
		 * objDto.getSalario(),objDto.getSenha(),objDto.getLogradouro(),objDto.getNumero
		 * (),
		 * objDto.getComplemento(),objDto.getBairro(),objDto.getCep(),objDto.getCargo(),
		 * TipoFuncionario.toEnum(objDto.getTipo()));
		 */

		Endereco end = new Endereco(null, objDto.getLogradouro(), objDto.getNumero(), objDto.getComplemento(),
				objDto.getBairro(), objDto.getCep(), func);
	...
	public Funcionario fromDTO(FuncionarioDTO objDto) {
		...
		Funcionario func = new Funcionario(null, objDto.getNm_func(), null, null, objDto.getEmail_func(), 0, null, null,
				null, null, null, null, objDto.getCargoId(), null, null);
